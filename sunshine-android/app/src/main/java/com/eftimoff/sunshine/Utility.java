...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        ...
        return prefs.getString(context.getString(R.string.preference_metric_key),
                context.getString(R.string.preference_metric_metric))
                .equals(context.getString(R.string.preference_metric_metric));
    }
        ...
        try {
            ...
            if (WeatherContract.getDbDateString(todayDate).equals(dateStr)) {
                ...
                if (WeatherContract.getDbDateString(tomorrowDate).equals(
                    ...
                    final String input = dayFormat.format(inputDate);
                    final String output = input.substring(0, 1).toUpperCase() + input.substring(1);
                    return output;
                }
            }
