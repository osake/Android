...
public class DownloaderTask extends AsyncTask<String, Void, String[]> {
	...
	private void notify(final boolean success) {
		...
		mApplicationContext.sendOrderedBroadcast(new Intent(MainActivity.DATA_REFRESHED_ACTION),
				null, new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							RemoteViews mContentView = new RemoteViews(mApplicationContext
							...
							Notification.Builder notificationBuilder = new Notification.Builder(
									mApplicationContext).setContentIntent(pendingIntent)
									.setContent(mContentView)
									.setSmallIcon(android.R.drawable.stat_sys_warning)
									.setAutoCancel(true);

							// TODO: Send the notification
							NotificationManager mNotificationManager = (NotificationManager) mParentActivity
	...
	private void saveTweetsToFile() {
		...
		try {
			FileOutputStream fos = mApplicationContext.openFileOutput(MainActivity.TWEET_FILENAME,
