...
public class SynchronizedQueue {
	...
	public enum SynchronizedQueueResult {
		RAN_PROPERLY("Threads Ran Properly."), JOIN_NEVER_CALLED("Join() never called."), THREADS_NEVER_RAN(
				"Threads never ran."), THREADS_NEVER_INTERUPTED("Threads never interrupted."), THREADS_THREW_EXCEPTION(
				"Thread threw an exception."), THREADS_NEVER_CREATED("Threads never created."), TESTING_LOGIC_THREW_EXCEPTION(
