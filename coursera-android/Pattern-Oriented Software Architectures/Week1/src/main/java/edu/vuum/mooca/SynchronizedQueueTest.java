 ...
 * 
 * @brief This class tests queues for proper functionality by using the
 *        testQueue method defined in SynchronizedQueue.java
 */
public class SynchronizedQueueTest {
	 ...
	 * 
	 * @return result. If SynchronizedQueue test ran properly, returns null. If
	 *         not, returns error message.
	 */
	...
	public void arrayBlockingQueueTest() {
		QueueAdapter<Integer> queueAdapter = new QueueAdapter<Integer>(
	...
	public void buggyBlockingQueueTest() {
		...
		assertNotNull("Test should not complete without errors. "
				+ "BuggyBlockingQueue is intended to function incorrectly.", errors);
	}
