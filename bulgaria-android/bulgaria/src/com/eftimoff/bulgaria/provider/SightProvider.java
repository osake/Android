...
public class SightProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.eftimoff.bulgaria.sightprovider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_SIGHT = 0;
    private static final int URI_TYPE_SIGHT_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, SightColumns.TABLE_NAME, URI_TYPE_SIGHT);
        URI_MATCHER.addURI(AUTHORITY, SightColumns.TABLE_NAME + "/#", URI_TYPE_SIGHT_ID);
    }

    private BulgariaSQLiteOpenHelper mBulgariaSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mBulgariaSQLiteOpenHelper = BulgariaSQLiteOpenHelper.newInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_SIGHT:
                return TYPE_CURSOR_DIR + SightColumns.TABLE_NAME;
            case URI_TYPE_SIGHT_ID:
                return TYPE_CURSOR_ITEM + SightColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mBulgariaSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mBulgariaSQLiteOpenHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mBulgariaSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection);
        int res = mBulgariaSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (BuildConfig.DEBUG)
            Log.d(TAG, "query uri=" + uri + " selection=" + selection + " selectionArgs=" + Arrays.toString(selectionArgs) + " sortOrder=" + sortOrder
                    + " groupBy=" + groupBy);
        QueryParams queryParams = getQueryParams(uri, selection);
        Cursor res = mBulgariaSQLiteOpenHelper.getReadableDatabase().query(queryParams.table, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection) {
        ...
        switch (matchedId) {
            case URI_TYPE_SIGHT:
            case URI_TYPE_SIGHT_ID:
                res.table = SightColumns.TABLE_NAME;
                res.orderBy = SightColumns.DEFAULT_ORDER;
                break;
